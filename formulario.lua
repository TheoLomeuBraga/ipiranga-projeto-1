...
formularios = {
  novo_formulario("18 - 25 anos",false,"Uso semanlmente","Semanalmente","Facilidade de pagamento","","O aplicativo é muito bom no geral, não tenho críticas só elogios",extra,""),
  novo_formulario("26 - 35 anos",false,"Nunca Utilizei","não uso","Outros","","",extra,""),
  novo_formulario("26 - 35 anos",false,"Nunca Utilizei","não uso","Outros","","",extra,""),
  novo_formulario("18 - 25 anos",false,"Nunca Utilizei","não uso","Outros","","",extra,""),
  novo_formulario("18 - 25 anos",false,"Nunca Utilizei","não uso","","","",extra,""),
  novo_formulario("18 - 25 anos",false,"Nunca Utilizei","não uso","Qualidade dos produtos oferecidos",false,"",extra,""),
  novo_formulario("18 - 25 anos",false,"Nunca Utilizei","não uso","Outros","","",extra,""),
  novo_formulario("18 - 25 anos",false,"Nunca Utilizei","não uso","Outros","","",extra,""),
  novo_formulario("26 - 35 anos",false,"Nunca Utilizei","não uso","Outros","","",extra,""),
  novo_formulario("18 - 25 anos",false,"Nunca Utilizei","não uso","Facilidade de pagamento","","",extra,""),
  novo_formulario("18 - 25 anos",false,"Nunca Utilizei","não uso","Outros","","",extra,""),
  novo_formulario("18 - 25 anos",false,"Nunca Utilizei","não uso","Outros","","",extra,""),
  novo_formulario("18 - 25 anos",false,"Nunca Utilizei","não uso","Qualidade dos produtos oferecidos",false,"",extra,""),
  novo_formulario("46-55 anos",false,"Nunca Utilizei","não uso","Descontos e vantagens exclusivas",false,"Melhorar a divulgação ",extra,""),
  novo_formulario("36 - 45 anos",false,"Nunca Utilizei","não uso","Outros","","",extra,""),
  novo_formulario("26 - 35 anos",false,"Nunca Utilizei","não uso","Descontos e vantagens exclusivas","","",extra,""),
  novo_formulario("46-55 anos",false,"Nunca Utilizei","não uso","Outros","","",extra,""),
  novo_formulario("26 - 35 anos",false,"Nunca Utilizei","não uso","Descontos e vantagens exclusivas",false,"Desconto",extra,""),
  novo_formulario("26 - 35 anos",false,"Nunca Utilizei","não uso","Descontos e vantagens exclusivas","","",extra,""),
  novo_formulario("26 - 35 anos",false,"Nunca Utilizei","não uso","Outros",false,"Não sei",extra,""),
  novo_formulario("Mais de 55 anos",false,"Nunca Utilizei","não uso","","","",extra,""),
  novo_formulario("18 - 25 anos",true,"Uso ocasionalmente","Ocasionalmente","Qualidade dos produtos oferecidos",false,"",extra,""),
  novo_formulario("46-55 anos",false,"Nunca Utilizei","não uso","Outros","","",extra,""),
  novo_formulario("Mais de 55 anos",false,"Nunca Utilizei","não uso","Descontos e vantagens exclusivas",false,"Não tenho o clube de vantagem. Portanto não posso opinar.",extra,""),
  novo_formulario("46-55 anos",false,"Nunca Utilizei","não uso","Outros",false,"Nao sei informar",extra,""),
  novo_formulario("26 - 35 anos",false,"Nunca Utilizei","não uso","","","",extra,""),
  novo_formulario("18 - 25 anos",false,"Nunca Utilizei","não uso","Outros","","",extra,""),
  novo_formulario("18 - 25 anos",false,"Nunca Utilizei","não uso","Outros",true,"",extra,""),
  novo_formulario("18 - 25 anos",false,"Nunca Utilizei","não uso","Outros",false,"não uso o aplicativo não sabia de sua existencia, acredito que sempre da para melhorar ",extra,""),
}
