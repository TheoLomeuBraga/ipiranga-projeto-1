...
formularios = {
  novo_formulario("18 - 25 anos",false,"Uso semanlmente","Semanalmente","Facilidade de pagamento","",sujestao_melhoria,extra,""),
  novo_formulario("26 - 35 anos",false,"Nunca Utilizei","não uso","Outros","",sujestao_melhoria,extra,""),
  novo_formulario("26 - 35 anos",false,"Nunca Utilizei","não uso","Outros","",sujestao_melhoria,extra,""),
  novo_formulario("18 - 25 anos",false,"Nunca Utilizei","não uso","Outros","",sujestao_melhoria,extra,""),
  novo_formulario("18 - 25 anos",false,"Nunca Utilizei","não uso","","",sujestao_melhoria,extra,""),
  novo_formulario("18 - 25 anos",false,"Nunca Utilizei","não uso","Qualidade dos produtos oferecidos",false,sujestao_melhoria,extra,""),
  novo_formulario("18 - 25 anos",false,"Nunca Utilizei","não uso","Outros","",sujestao_melhoria,extra,""),
  novo_formulario("18 - 25 anos",false,"Nunca Utilizei","não uso","Outros","",sujestao_melhoria,extra,""),
  novo_formulario("26 - 35 anos",false,"Nunca Utilizei","não uso","Outros","",sujestao_melhoria,extra,""),
  novo_formulario("18 - 25 anos",false,"Nunca Utilizei","não uso","Facilidade de pagamento","",sujestao_melhoria,extra,""),
  novo_formulario("18 - 25 anos",false,"Nunca Utilizei","não uso","Outros","",sujestao_melhoria,extra,""),
  novo_formulario("18 - 25 anos",false,"Nunca Utilizei","não uso","Outros","",sujestao_melhoria,extra,""),
  novo_formulario("18 - 25 anos",false,"Nunca Utilizei","não uso","Qualidade dos produtos oferecidos",false,sujestao_melhoria,extra,""),
  novo_formulario("46-55 anos",false,"Nunca Utilizei","não uso","Descontos e vantagens exclusivas",false,sujestao_melhoria,extra,""),
  novo_formulario("36 - 45 anos",false,"Nunca Utilizei","não uso","Outros","",sujestao_melhoria,extra,""),
  novo_formulario("26 - 35 anos",false,"Nunca Utilizei","não uso","Descontos e vantagens exclusivas","",sujestao_melhoria,extra,""),
  novo_formulario("46-55 anos",false,"Nunca Utilizei","não uso","Outros","",sujestao_melhoria,extra,""),
  novo_formulario("26 - 35 anos",false,"Nunca Utilizei","não uso","Descontos e vantagens exclusivas",false,sujestao_melhoria,extra,""),
  novo_formulario("26 - 35 anos",false,"Nunca Utilizei","não uso","Descontos e vantagens exclusivas","",sujestao_melhoria,extra,""),
  novo_formulario("26 - 35 anos",false,"Nunca Utilizei","não uso","Outros",false,sujestao_melhoria,extra,""),
  novo_formulario("Mais de 55 anos",false,"Nunca Utilizei","não uso","","",sujestao_melhoria,extra,""),
  novo_formulario("18 - 25 anos",true,"Uso ocasionalmente","Ocasionalmente","Qualidade dos produtos oferecidos",false,sujestao_melhoria,extra,""),
  novo_formulario("46-55 anos",false,"Nunca Utilizei","não uso","Outros","",sujestao_melhoria,extra,""),
  novo_formulario("Mais de 55 anos",false,"Nunca Utilizei","não uso","Descontos e vantagens exclusivas",false,sujestao_melhoria,extra,""),
  novo_formulario("46-55 anos",false,"Nunca Utilizei","não uso","Outros",false,sujestao_melhoria,extra,""),
  novo_formulario("26 - 35 anos",false,"Nunca Utilizei","não uso","","",sujestao_melhoria,extra,""),
  novo_formulario("18 - 25 anos",false,"Nunca Utilizei","não uso","Outros","",sujestao_melhoria,extra,""),
  novo_formulario("18 - 25 anos",false,"Nunca Utilizei","não uso","Outros",true,sujestao_melhoria,extra,""),
  novo_formulario("18 - 25 anos",false,"Nunca Utilizei","não uso","Outros",false,sujestao_melhoria,extra,""),
}
